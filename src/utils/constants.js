...
const REGEX_NAME_PATTERN = '^[а-яА-ЯёЁa-zA-Z\s\-]+$';
...
export { 
    ...
    ADD_SHOW_MOVIES_0, ADD_SHOW_MOVIES_2, ADD_SHOW_MOVIES_3, ADD_SHOW_MOVIES_7, SHORT_DURATION_VALUE, 
    ...
    MIN_LENGTH_VALUE, MAX_LENGTH_VALUE, MIN_PASS_LENGTH_VALUE, REGEX_NAME_PATTERN
};
